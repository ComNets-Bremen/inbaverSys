...
class Worker(Thread):
    ...
    def run(self):
        ...
        facereg.face_id = settings.IPOVERWLAN_FACE_IDS[faceindex]
        ...
        encap.from_face_id = settings.IPOVERWLAN_FACE_IDS[faceindex]
        ...
        s.bind(('', settings.IPOVERWLAN_LOCAL_PORTS[faceindex]))
