...
def setup(dispatch):
    ...
    # log
    logmsg = settings.IPOVERETH_MODULE_NAME + ' : Setup completed, operation started'        
...
class Worker(Thread):
    ...
    def run(self):
        ...
        try:
            ...
            facereg.face_id = settings.IPOVERETH_FACE_IDS[self.faceindex]
            ...
            encap.from_face_id = settings.IPOVERETH_FACE_IDS[self.faceindex]
            ...
            s.bind(('', settings.IPOVERETH_LOCAL_PORTS[self.faceindex]))
